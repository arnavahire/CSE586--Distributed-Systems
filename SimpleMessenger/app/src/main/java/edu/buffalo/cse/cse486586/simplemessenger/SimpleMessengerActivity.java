            ...
            */
                 /*   if (disServer != null) {
                        try {
                            ...
                            Log.e(TAG, "Data Input stream exception");
                        }
                    }
                   s.close();
                */
        ...
        protected Void doInBackground(String... msgs) {
            try {
                ...
                */
                    ...
                    dosClient.writeUTF(msgToSend);
                    */
                 /*   if (dosClient != null) {
                        try {
                            dosClient.close();
                        } catch (Exception e) {
                            Log.e(TAG, "Client data output stream exception");
                        }
                    }
                   */
